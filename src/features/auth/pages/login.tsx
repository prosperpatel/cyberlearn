  ...
  return (
    <div className="space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">Sign in to continue your mission</p>
      </div>
      ...
      <Button variant="outline" size="lg" className="w-full gap-3" disabled>
      ...
      <p className="text-center text-sm text-muted-foreground">
        ...
        <Link to={ROUTES.AUTH.REGISTER} className="font-semibold text-primary hover:underline">
          Create one
        </Link>
      </p>
    </div>
